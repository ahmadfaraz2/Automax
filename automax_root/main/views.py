...
def list_view(request):
    if request.method == "POST":
        try:
            ...
            if listing_form.is_valid() and location_form.is_valid():
                ...
                listing.save()
                messages.info(request, f"{listing.model} Listing Posted Sucessfully")
    ...
    return render(
        request,
        "views/list.html",
        {"listing_form": listing_form, "location_form": location_form},
    )
    ...
    try:
        ...
        if request.method == "POST":
            ...
            if listing_form.is_valid() and location_form.is_valid():
                ...
                messages.error(request, f"An error occured trying to edit the listing.")
                return reload()
        else:
